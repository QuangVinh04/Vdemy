...
public enum ErrorCode {
    ...
    CATEGORY_ALREADY_EXISTS(3011, "Category already exists", HttpStatus.BAD_REQUEST),
    ...
    PAYMENT_METHOD_NOT_SUPPORTED(8002, "Payment method not supported", HttpStatus.BAD_REQUEST),
