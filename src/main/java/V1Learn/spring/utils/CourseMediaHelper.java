...
public class CourseMediaHelper {
    ...
    public void handleMediaUpload(Course course, MultipartFile thumbnail, MultipartFile video, boolean deleteOld) {
        if (thumbnail != null) {
            if (deleteOld && course.getThumbnailUrl() != null) {
        ...
        if (video != null) {
            if (deleteOld && course.getVideoUrl() != null) {
