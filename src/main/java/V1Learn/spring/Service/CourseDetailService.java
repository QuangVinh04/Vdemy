...
public class CourseDetailService {
    ...
    public CourseDetailResponse getCourseDetail(String courseId, Set<String> fields) {
        ...
        AccessDecision accessResult = courseAccessService.checkUserAccess(courseId, course, userId);
    ...
    private CourseDetailResponse buildCourseDetailResponse(
        ...
        if (fields.contains("stats")) {
            CourseStats stats = CourseStats.builder()
                    ...
                    .totalChapters((long) container.chapterSummaries.size())
                    .totalLessons(container.chapterSummaries.stream()
                            .mapToLong(ChapterSummaryProjection::getTotalLessons) .sum())
